...
public class CrossDriver {
    ...
    //eger browser'a bir deger atanmamissa ConfigReader'daki browser calissin.
        ...
        //Test'lerimizi xml file'dan farkli browser'lar ile calistirabilmek icin getDriver method'una
        //parametre atamamiz gerekir.
        if (driver == null) {

            switch (browser){
                //CrossBrowser icin bizim gonderdgimiz Browser uzerinden calismasi icin
